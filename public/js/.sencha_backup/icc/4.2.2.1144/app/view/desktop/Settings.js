...
Ext.define('icc.view.desktop.Settings', {
    ...
    requires: [
        ...
        'icc.view.desktop.WallpaperModel'
    ],
    ...
    initComponent: function () {
        ...
        //me.preview = Ext.create('wallpaper');
		me.preview = Ext.widget('wallpaper');
    ...
    createTree : function() {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: 'icc.view.desktop.WallpaperModel',
                root: {
                    text:'Wallpaper',
                    expanded: true,
                    children:[
